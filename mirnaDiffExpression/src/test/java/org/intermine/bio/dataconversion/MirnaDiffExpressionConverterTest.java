...
public class MirnaDiffExpressionConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    MirnaDiffExpressionConverter converter;
    MockItemWriter itemWriter;

    public MirnaDiffExpressionConverterTest(String arg) {
        super(arg);
    }
