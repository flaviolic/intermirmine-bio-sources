...
public class GeneDiffExpressionConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    GeneDiffExpressionConverter converter;
    MockItemWriter itemWriter;

    public GeneDiffExpressionConverterTest(String arg) {
        super(arg);
    }
